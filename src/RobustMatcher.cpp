...
void RobustMatcher::myMatch(Mat image1, Mat image2, vector<vector<DMatch>> matches, int k){

    vector<cv::KeyPoint> keypoints1;
    vector<cv::KeyPoint> keypoints2;

    detector_->detect(image1, keypoints1);
    detector_->detect(image2, keypoints2);
