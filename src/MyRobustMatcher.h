...
public:
    ...
    cv::Mat matchSimple(cv::Mat& image1, cv::Mat& descriptors2, // input images
        ...
        //cout << "Number of SURF points (1): " << keypoints1.size() << std::endl;
        //cout << "Number of SURF points (2): " << keypoints2.size() << std::endl;
