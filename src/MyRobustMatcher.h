...
#ifndef REPHOTOGRAFING_MYMATCHER_H
#define REPHOTOGRAFING_MYMATCHER_H
...
public:
    ...
    MyRobustMatcher() : ratio(0.65f), refineF(true), confidence(0.99), distance(3.0) {
    ...
    cv::Mat matchSimple(cv::Mat &image1, cv::Mat &descriptors2, std::vector<cv::DMatch> &matches,
    ...
    cv::Mat
    match(cv::Mat &image1, cv::Mat &image2, std::vector<cv::DMatch> &matches, std::vector<cv::KeyPoint> &keypoints1,
...
#endif //REPHOTOGRAFING_MYMATCHER_H
